	...
	<view class="Hybody">
		...
		<view class="fabuContent">
			...
			<view class="fabuList">
				...
				<view class="fabuIpt">
					<input type="text" placeholder="请输入活动主题不要超过16个字">
				</view>
			</view>
			<view class="fabuList">
				<view class="fabuLeftText">
			...
			<view class="fabuList">
				...
				<view class="fabuIpt" style="width: 300upx;">
					<view class="uni-form-item uni-column">
						<picker @change="bindPickerChange" :range="array">	
							<label class="">{{array[index]}}</label>		
						</picker>
				...
				<view style="width: 100upx;margin-left: 30upx;">
					星
				</view>
			</view>
			<view class="fabuList">
			...
			<view class="fabuList">
				...
				<view class="fabuIpt"  style="display: flex;justify-content: start;align-items: center;">
			...
			<view class="fabuDitu">
				...
				<view class="" style="text-align: center;color: #3B3838;">
					注；请地图上准确选择活动地点
				</view>
			</view>
			<view class="">
				...
				<view class="" style="margin-bottom: 20upx;color: #3B3838;">
					注：请上传正方形海报图，效果最佳（400x400）像素，海报图片有瑕疵审核会被驳回风险。
				</view>
			</view>
